...
def run_automated_trading(api_key: str, model: str = "gpt-4o-mini", data_dir: str = "Start Your Own", dry_run: bool = False):
    ...
    portfolio_file = data_path / "ai_trader_portfolio_update.csv"
